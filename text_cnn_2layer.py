      ...
      embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        for i, filter_size in enumerate(filter_sizes):
            with tf.name_scope("conv-maxpool-%s" % filter_size):
                ...
                #    padding='VALID',
                #    name="pool")
                #pooled_outputs.append(pooled) moved after 2nd cnn
                ...
                pooled2 = tf.nn.max_pool(
                    conv2,
                    ksize=[1, sequence_length - filter_size + 1 -4, 1, 1], #2nd +1, targeting to make it b. 1200 -> 1, but conv1 cutaway alreayd a bit)
                    strides=[1, 1, 1, 1],
                    padding='VALID',
                    name="pool2")
